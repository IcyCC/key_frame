...
[M,N,C] = size(I) ;%求I的维数大小，M为行向量，N为列向量，C为第三维
...
scalespace = do_gaussian(I,sigmaN,O,S,omin,-1,S+1,sigma0) ;   %function L = do_gaussian(I,sigmaN,O,S,omin,smin,smax,sigma0)
